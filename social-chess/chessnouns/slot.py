...
class Slot(object):
    ...
    def __init__(self, slot_player, raw_points, weighted_points):
    ...
    def __str__(self):
        return "{} |{}|{}".format(self._player.get_name(), self._raw_points, self._weighted_points)
    ...
    def get_line(self):
        ...
        """
        return self._player.get_name(), self._raw_points, self._weighted_points
